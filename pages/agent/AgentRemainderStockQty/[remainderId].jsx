...
const AgentRemainderStockQty = (props) => {
...
export async function getServerSideProps(context) {
  const id = context.params.remainderId;

  const { data } = await axios.get(process.env.API_URL + "/agentPanel/av1/AgentProductRemainderStockQty/" + id);
